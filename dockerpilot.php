...
require_once 'commands/RoundcubeStartCommand.php';
require_once 'commands/RoundcubeStopCommand.php';
...
$dockerpilot->add( new Dockerpilot\Command\RoundcubeStartCommand() );
$dockerpilot->add( new Dockerpilot\Command\RoundcubeStopCommand() );

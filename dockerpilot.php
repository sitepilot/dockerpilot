...
require_once 'commands/AppCmdCommand.php';
require_once 'commands/AppLoginCommand.php';
...
$dockerpilot->add( new Dockerpilot\Command\AppCmdCommand() );
$dockerpilot->add( new Dockerpilot\Command\AppLoginCommand() );

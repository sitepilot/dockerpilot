...
require_once 'commands/TemplateStartCommand.php';
require_once 'commands/TemplateStopCommand.php';
...
$serverpilot->add( new Serverpilot\Command\TemplateStartCommand() );
$serverpilot->add( new Serverpilot\Command\TemplateStopCommand() );
